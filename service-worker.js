const CACHE="tw-pvp-v5-layout-responsivo";
const ASSETS=["./","./index.html","./manifest.webmanifest","./tw-clothes-logo.webp","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./favicon.ico"];
